			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"Ui5TechShop-display": {
								"semanticObject": "Ui5TechShop",
								"action": "display",
								"description": "Ui5 Tech-Shop",
								"title": "Ui5 Tech-Shop",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=Demo.Tech-Shop",
									"url": sap.ui.require.toUrl("Demo/Tech-Shop")
								}
							}
						}
					}
